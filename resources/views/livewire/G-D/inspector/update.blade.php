...
<div class="card card-warning" wire:init="$dispatch('_rendered_')">
    <div class="card-header">
        <h3 class="card-title">{{__('Inspector._update_title_')}}</h3>
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form class="form-horizontal" wire:submit.prevent='update' novalidate>
        <fieldset>
            <div class="card-body">
                <div class="row">
        ...
        <div class="card-footer">
            ...
            <button type="submit" class="btn btn-warning float-right"
                wire:dirty>{{__('Inspector._update_btn_')}}</button>
        </div>
        <!-- /.card-footer -->
    </form>
</div>
